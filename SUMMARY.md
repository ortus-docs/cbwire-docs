...
* [Releases](releases/README.md)
  ...
  * [What's New With 3.1](releases/whats-new-with-3.1.md)
  * [What's New With 3.0](releases/whats-new-with-3.0.md)
  * [What's New With 2.2](releases/whats-new-with-2.2.md)
...
* [Components](the-essentials/components.md)
* [Templates](the-essentials/templates.md)
* [Data Properties](the-essentials/properties.md)
* [Computed Properties](the-essentials/computed-properties.md)
* [Data Binding](the-essentials/data-binding.md)
* [Actions](the-essentials/actions.md)
* [Events](the-essentials/events.md)
* [Nesting Components](the-essentials/nesting-components.md)
* [Lifecycle Methods](the-essentials/lifecycle-events.md)
* [JavaScript](the-essentials/javascript.md)
* [Testing](the-essentials/testing.md)

## Features

* [Single-file Components](features/single-file-components.md)
* [Alpine.js](features/alpine.js.md)
* [Lazy Loading](features/lazy-loading.md)
* [Form Validation](features/form-validation.md)
...
* [wire:key](template-directives/wire-key.md)
* [wire:loading](template-directives/wire-loading.md)
* [wire:model](template-directives/wire-model.md)
